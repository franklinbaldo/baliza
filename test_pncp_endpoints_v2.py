...
def main():
    ...
    proposta_params = [
        ...
        {"tamanhoPagina": 500, "pagina": 1, "dataFinal": "20300101"}, # Try larger page size
    ]
    ...
    instrumentos_params = [
        {"tamanhoPagina": 50, "pagina": 1, "dataInicial": recent_date_start, "dataFinal": recent_date_end},
        {"tamanhoPagina": 50, "pagina": 1, "dataInicial": "20240701", "dataFinal": "20240730"},  # 30 days in 2024
        {"tamanhoPagina": 50, "pagina": 1, "dataInicial": "20240601", "dataFinal": "20240630"},  # 30 days in 2024
    ]
    ...
    pca_atualizacao_params = [
        {"tamanhoPagina": 50, "pagina": 1, "dataInicio": recent_date_start, "dataFim": recent_date_end},
        {"tamanhoPagina": 50, "pagina": 1, "dataInicio": "20240701", "dataFim": "20240730"},
