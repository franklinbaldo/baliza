...
@then(parsers.parse("the extraction resumes from the saved page"))
def check_resumed_from_page_alias(resume_result):
    """Alias for 'extraction should start from page {page}'."""
    pass
