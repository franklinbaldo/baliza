...
class TestEndpointValidator:
    ...
    def test_validate_endpoint_params(self):
        ...
        result = validator.validate_endpoint_params("contratacoes_publicacao", valid_params)
        ...
        result = validator.validate_endpoint_params("contratacoes_publicacao", invalid_params)
