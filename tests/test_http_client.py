...
from src.baliza.legacy.utils.http_client import (
    PNCPResponse,
    APIRequest,
    AdaptiveRateLimiter,
    PNCPClient,
...
from src.baliza.legacy.utils.circuit_breaker import CircuitState
...
class TestCircuitBreaker:
    ...
    def test_initial_state(self):
        ...
        from src.baliza.legacy.utils.circuit_breaker import (
            CircuitBreaker,
...
@pytest.mark.asyncio
@patch("src.baliza.legacy.utils.http_client.get_run_logger")
