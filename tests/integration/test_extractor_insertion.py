...
def test_extractor_insertion_logic(tmp_path):
    ...
    sample_data = [
        {
            ...
            "anoCompra": 2023,
            "sequencialCompra": 1,
            "orgaoEntidade": {"cnpj": "12345678000190", "razaoSocial": "Test Org", "poderId": "1"},
            "unidadeOrgao": {"codigoUnidade": "123", "nomeUnidade": "Test Unit"},
            "modalidadeId": 1,
    ...
    with patch("baliza.extractor._fetch_page") as mock_fetch:
        ...
        mock_fetch.side_effect = [
            {"data": sample_data, "totalPaginas": 1, "totalRegistros": 1, "numeroPagina": 1},
            {"data": [], "totalPaginas": 1, "totalRegistros": 1, "numeroPagina": 2},
        ]
        ...
        with duckdb.connect(str(db_path)) as con:
            ...
            row = con.execute(
                "SELECT numero_controle_pncp, valor_inicial FROM baliza_raw.contratos"
            ).fetchone()
