...
Feature: State Management
  As a data engineer,
  I want to inspect the state of the Baliza data extraction process,
  ...
  Scenario: Show the history of the data extraction process
    ...
    When I run the "baliza state history" command
