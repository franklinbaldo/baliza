...
ENDPOINTS_REQUIRING_MODALIDADE = {"contratacoes_publicacao", "contratacoes_atualizacao"}
    ...
    for resource_type in ["sync", "backfill", "specialized"]:
        ...
        for resource_config in resource_configs:
            ...
            if _requires_modalidade(resource_name):
                ...
                print(
                    f"   ⚠️  {resource_name} REQUER modalidade → gerou {count} resources"
                )
        ...
        print(
            f"   🎯 Total de resources finais para '{resource_type}': {total_final_resources}"
        )
