...
from baliza.utils.http_client import PNCPClient, EndpointExtractor
...
async def collect_contratacoes_publicacao_fixture():
    ...
    modalidade = get_enum_by_value(ModalidadeContratacao, settings.HIGH_PRIORITY_MODALIDADES[0])
    ...
    try:
        ...
        import zlib
        response_json = json.loads(zlib.decompress(api_request.payload_compressed).decode('utf-8'))
        
        # Save to fixture file
        fixture_path = Path(__file__).parent.parent / "tests/fixtures/contratacoes_publicacao_response.json"
...
async def collect_contratos_fixture():
    ...
    try:
        ...
        # Save to fixture file
        fixture_path = Path(__file__).parent.parent / "tests/fixtures/contratos_response.json"
...
async def collect_atas_fixture():
    ...
    try:
        ...
        # Save to fixture file
        fixture_path = Path(__file__).parent.parent / "tests/fixtures/atas_response.json"
...
async def collect_orgaos_fixture():
    ...
    try:
        ...
        # Save to fixture file
        fixture_path = Path(__file__).parent.parent / "tests/fixtures/orgaos_response.json"
...
async def collect_all_fixtures():
    ...
    print(f"📅 Usando período: últimos 30 dias")
