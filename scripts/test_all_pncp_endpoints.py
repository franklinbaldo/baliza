    ...
    for i, params in enumerate(params_list, 1):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("   No content (valid response)")
                return True
...
def main():
    ...
    if test_endpoint(
        "contratos/atualizacao", contratos_atualizacao_params, "contratos_atualizacao"
    ):
    ...
    pca_params = [
        ...
        },
        {
            ...
            "pagina": 1,
            "anoPca": 2021,
            "codigoClassificacaoSuperior": "10",
        },
    ]
