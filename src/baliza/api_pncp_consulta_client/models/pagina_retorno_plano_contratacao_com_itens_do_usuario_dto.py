...
if TYPE_CHECKING:
    from ..models.plano_contratacao_com_itens_do_usuario_dto import PlanoContratacaoComItensDoUsuarioDTO


T = TypeVar("T", bound="PaginaRetornoPlanoContratacaoComItensDoUsuarioDTO")


@_attrs_define
class PaginaRetornoPlanoContratacaoComItensDoUsuarioDTO:
    """
    Attributes:
        data (Union[Unset, list['PlanoContratacaoComItensDoUsuarioDTO']]):
    ...
    data: Union[Unset, list["PlanoContratacaoComItensDoUsuarioDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = PlanoContratacaoComItensDoUsuarioDTO.from_dict(data_item_data)
        ...
        pagina_retorno_plano_contratacao_com_itens_do_usuario_dto = cls(
            data=data,
        ...
        pagina_retorno_plano_contratacao_com_itens_do_usuario_dto.additional_properties = d
        return pagina_retorno_plano_contratacao_com_itens_do_usuario_dto
