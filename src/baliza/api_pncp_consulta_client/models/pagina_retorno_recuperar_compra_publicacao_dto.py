...
if TYPE_CHECKING:
    from ..models.recuperar_compra_publicacao_dto import RecuperarCompraPublicacaoDTO


T = TypeVar("T", bound="PaginaRetornoRecuperarCompraPublicacaoDTO")


@_attrs_define
class PaginaRetornoRecuperarCompraPublicacaoDTO:
    """
    Attributes:
        data (Union[Unset, list['RecuperarCompraPublicacaoDTO']]):
    ...
    data: Union[Unset, list["RecuperarCompraPublicacaoDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = RecuperarCompraPublicacaoDTO.from_dict(data_item_data)
        ...
        pagina_retorno_recuperar_compra_publicacao_dto = cls(
            data=data,
        ...
        pagina_retorno_recuperar_compra_publicacao_dto.additional_properties = d
        return pagina_retorno_recuperar_compra_publicacao_dto
