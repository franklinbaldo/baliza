...
if TYPE_CHECKING:
    from ..models.consultar_instrumento_cobranca_dto import ConsultarInstrumentoCobrancaDTO


T = TypeVar("T", bound="PaginaRetornoConsultarInstrumentoCobrancaDTO")


@_attrs_define
class PaginaRetornoConsultarInstrumentoCobrancaDTO:
    """
    Attributes:
        data (Union[Unset, list['ConsultarInstrumentoCobrancaDTO']]):
    ...
    data: Union[Unset, list["ConsultarInstrumentoCobrancaDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ConsultarInstrumentoCobrancaDTO.from_dict(data_item_data)
        ...
        pagina_retorno_consultar_instrumento_cobranca_dto = cls(
            data=data,
        ...
        pagina_retorno_consultar_instrumento_cobranca_dto.additional_properties = d
        return pagina_retorno_consultar_instrumento_cobranca_dto
