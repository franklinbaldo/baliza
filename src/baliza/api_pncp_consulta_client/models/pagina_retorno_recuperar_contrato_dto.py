...
T = TypeVar("T", bound="PaginaRetornoRecuperarContratoDTO")


@_attrs_define
class PaginaRetornoRecuperarContratoDTO:
    """
    Attributes:
        data (Union[Unset, list['RecuperarContratoDTO']]):
    ...
    data: Union[Unset, list["RecuperarContratoDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = RecuperarContratoDTO.from_dict(data_item_data)
        ...
        pagina_retorno_recuperar_contrato_dto = cls(
            data=data,
        ...
        pagina_retorno_recuperar_contrato_dto.additional_properties = d
        return pagina_retorno_recuperar_contrato_dto
