...
class PlanFingerprint:
    ...
    def _filter_for_fingerprint(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "endpoints" in filtered:
            ...
            for endpoint_name, endpoint_config in filtered["endpoints"].items():
                if "modalidades" in endpoint_config and isinstance(
                    endpoint_config["modalidades"], list
                ):
                    endpoint_config["modalidades"] = sorted(
                        endpoint_config["modalidades"]
                    )
    ...
    def get_plan_metadata(
        self, date_range_start: str, date_range_end: str, environment: str = "prod"
    ) -> Dict[str, Any]:
        ...
        fingerprint = self.generate_fingerprint(
            date_range_start, date_range_end, environment
        )
