...
def staging_transformation() -> Dict[str, Any]:
    ...
    try:
        ...
        contratos_count = con.raw_sql("SELECT COUNT(*) as cnt FROM staging.contratos").fetchone()[0] 
        atas_count = con.raw_sql("SELECT COUNT(*) as cnt FROM staging.atas").fetchone()[0]
