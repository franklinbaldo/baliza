...
SELECT
  ...
  CAST(contract_data ->> 'valorInicial' AS DECIMAL(15,2)) AS valor_inicial,
  CAST(contract_data ->> 'valorGlobal' AS DECIMAL(15,2)) AS valor_global,
  CAST(contract_data ->> 'valorParcela' AS DECIMAL(15,2)) AS valor_parcela,
  CAST(contract_data ->> 'valorAcumulado' AS DECIMAL(15,2)) AS valor_acumulado,
